...
<body>
	<c:if test="${currentUserGG != null}">
		<nav class="primary-navigation navbar navbar-expand-lg navbar-light"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul>
					...
					<li><a href="../html/adminpage.html">Quản lý</a></li>
					<li class="account"><a href="../html/profile.html">Tài
							khoản &dtrif;</a>
						<ul class="dropdown">
							<li><a href="../html/updateprofile.html">Cập nhật tài
									khoản</a></li>
		...
		<aside class="sidebar">
			...
			<nav>
				<a href="../html/home.html"> <span> <i
						class="fa-solid fa-house"></i> <span>Trang chủ</span>
				</span>
				</a> <a id="showDialog"> <span> <i id="showDialog"
						class="fa-solid fa-plus"></i> <span>Đăng bài</span>
				</span>
				</a> <a href="../html/history.html"> <span> <i
						class="fa-solid fa-clock-rotate-left"></i> <span>Lịch sử</span>
				</span>
				</a> <a href="../html/message.html"> <span> <i
		...
		<section class="main">
			<input type="text" id="userName" class=""
				value="${currentUserGG.sub}" placeholder="Tìm kiếm"
			...
			<div class="container">
				<div class="wrapper">
					<section class="post">
						...
						<form action="#">
							<div class="content">
								<img src="../images/user/user.jpg" alt="logo">
								<div class="details">
									<p>dannk</p>
									<div class="privacy">
							...
							<div class="options">
								...
								<ul class="list">
									<li><img src="../images/icons/gallery.svg" alt="gallery"></li>
									<li><img src="../images/icons/tag.svg" alt="gallery"></li>
									<li><img src="../images/icons/emoji.svg" alt="gallery"></li>
									<li><img src="../images/icons/mic.svg" alt="gallery"></li>
								</ul>
							</div>
							<button>Post</button>
						</form>
		...
		<div class="container_notifications">
			...
			<main>
				<div class="notif_card unread">
					<img src="../images/user/user3.jpg" alt="avatar" />
				...
				<div>
					<div class="notif_card">
						<img src="../images/user/user2.jpg" alt="avatar" />
						<div class="description">
							<p class="user_activity">
		...
		<div class="follow">
			...
			<div class="list-following">
				...
				<div class="profile-card-follow">
					<div class="profile-pic">
						<img src="../images/user/user5.jpg" alt="">
					</div>
					<div>
