										...
										<div class="row">
											<div class="form-group col-md-4">
												<label for="inputState">Huyện</label> <select
													id="selectWards${posts.post.ID}" name="nameWards${posts.post.ID}" class="form-control">
											...
											<div class="form-group col-md-4">
												<label for="inputState">Tỉnh</label> <select
													id="selectDistrict${posts.post.ID}" name="nameDistrict${posts.post.ID}"
											...
											<div class="form-group col-md-4">
												<label for="inputState">Thành phố</label> <select
													id="selectProvinces${posts.post.ID}" name="nameProvinces${posts.post.ID}"
													class="form-control" onchange="getDistrictsUpdatePost(this,'${posts.post.ID}')">
		...
		<div class="post-container-update">
			<div class="post">
				...
				<div class="post-detail">
					...
					<textarea class="post-des-update" name="" id="" cols="45" rows="10">${updatepost.post}
                    			</textarea>
					<div class="name-product">
						<input class="input" value="${updatepost.product}"
							placeholder="<s:message code="main.nameproduct"/>" required=""
							type="text"> <span class="input-border"></span>
					</div>
					<div class="hashtag">
						<input class="input" value="${updatepost.hashTag}"
							placeholder="Hashtag" required="" type="text"> <span
							class="input-border"></span>
					</div>
					<div class="address">
						<!-- <input class="input" placeholder="Vị trí" required=""
